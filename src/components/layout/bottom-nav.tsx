...
const NAV_ITEMS = [
  ...
  { label: 'Log', href: '/training', icon: LogIcon },
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-zinc-900 border-t border-divider safe-area-bottom">
